...
Roles go out about 48 hours before the match, in person or through the team app with parents included. This is not the starting lineup, and roles may still change. The coach keeps the table; each player receives only her own row, then reviews the [position card](../positions/index.md) for each role and pictures its moments. Continue on a second sheet as needed.
