...
| 05 | `05-how-we-play.md` | New: selected sections of `docs/coaching-game-model.md` |
...
Tags go in square brackets inline with the text. They are meant to direct the delivery, not be spoken. The transcripts use only four:

| Tag | Use |
|---|---|
| `[short pause]` | A beat between items in a list |
...
- **Say-along mantras.** Every mantra is introduced as "Say the practice mantra with me", then a pause, then the words slowly. The mantras are named practice, game, next-play (Respond. Reflect. Learn. Next play.) and pressure (Want the moment.). Key cue lists work the same way ("Say them with me"): position cues, the penalty routine, protect-slow-show-wait-win, and the team standard.
...
- **Quizzes.** Short quizzes answer after a pause: communication calls, advantages, game state, sore versus pain, heading concussions, weekly hours, sleep, and the weak foot.
...
- **Track 05 (new):** team identity (§1), middle gear (§7–8), make a defender choose (§9), deception (§10), third player (§11), five lanes and weak side (§14–15), create advantages (§42), losing the ball and rest defense (§5, §20), pressing together and second balls (§23), restarts (§24), game state (§25).
